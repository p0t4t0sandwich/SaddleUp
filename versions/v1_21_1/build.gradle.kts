...
tasks.register<ShadowJar>("relocateFabricJar") {
    ...
    dependencies {
        exclude("dev/neuralnexus/saddleup/mixin/v1_21_1/vanilla/**")
    }
    relocate("dev.neuralnexus.saddleup.v1_16_1.vanilla", "dev.neuralnexus.saddleup.v1_16_1.y_intmdry")
    relocate("dev.neuralnexus.saddleup.v1_14_4.vanilla", "dev.neuralnexus.saddleup.v1_14_4.y_intmdry")
}
...
tasks.register<ShadowJar>("relocateForgeJar") {
    ...
    dependencies {
        exclude("dev/neuralnexus/saddleup/mixin/v1_21_1/vanilla/**")
        exclude("dev/neuralnexus/saddleup/v1_21_1/vanilla/**")
    }
}
